...
class CostTest {
    ...
    void deliveryCostCalculate(double expectedResult, double distance, boolean big, boolean fragile, String load) {
        Cost cost = new Cost();
        assertEquals(expectedResult, cost.deliveryCostCalc(distance, big, fragile, load));
    }
    ...
    static Stream<Arguments> validData() {
        return Stream.of(
                ...
                /** arguments(400, 30.1, false, true, "повышенная"),
                 ...
                 arguments(700, 45, true, true, "высокая"),
                 arguments(300, 15, true, true, "высокая"),
                 arguments(700, -1, true, true, "высокая")
                 arguments(400, 45, "tolik", "tolik", "повышенная")
                 **/
